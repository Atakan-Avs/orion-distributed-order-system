...
def publish_to_dlq(event: OutboxEvent, error: Exception):
    ...
    print(
        f"[Shipping Outbox Publisher] Event sent to DLQ. "
                ...
                try:
                    ...
                    if event.retry_count >= MAX_RETRY_COUNT:
                        try:
                            ...
                            print(
                                f"[Shipping Outbox Publisher] DLQ publish failed. "
                        ...
                        print(
                            f"[Shipping Outbox Publisher] Publish failed. "
